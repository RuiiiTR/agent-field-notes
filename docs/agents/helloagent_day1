...
## The agent loop
1. Agent recive users intention
2. Agent plans how to do with this intention
3. Agent will make plans to choose what to do with the intention
4. Agent will decide which tool to use and what steps to do
5. After the Agent finish the round
6. The enviroment feature sensor the changes of the intention
7. It will make Agent start over and over until the goal is reached.
